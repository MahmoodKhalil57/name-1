  ...
  <div class="q-pa-xl column flex-center">
    <div class="q-pt-md width-one">
      ...
      <p class="q-pa-md section-content">
        ...
        strong, fights against cancerous cells, controls cholesterol, and also
    ...
    <div class="row justify-center q-gutter-md width-two">
      <div class="width-three">
        ...
        <p class="mango-content">
          ...
          everyone's favourite. An Alphonso mango is the most premium variety of
          mangoes especially due to high content of beta-carotene and a
      ...
      <div class="width-three">
        ...
        <p class="mango-content">
          ...
          aliquid dicta illo laudantium dolore, itaque provident quisquam sint!
